 ...
 * Use the {@link ReportemascotasFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ReportemascotasFragment extends Fragment {
    ...
    public FragmentReportemascotasBinding binding;
    String Miurl = new URL().Miurl(); //
    WebView webView;

    public ReportemascotasFragment() {
     ...
     * @return A new instance of fragment ReportemascotasFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ReportemascotasFragment newInstance(String param1, String param2) {
        ReportemascotasFragment fragment = new ReportemascotasFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentReportemascotasBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.reporteMascotas.loadUrl(Miurl + "reporte_mascota.php");
